...
//-----------------------------------------------------------------------------------------------------------------------------
	...
	public function letestNews(){
		$data = array(
				"subject" => $this->input->post("title"),
				"thought" => $this->input->post("content"),
				"written_by" => $this->input->post("url"),
				"written_date" =>date("Y-m-d")
		);
		if($this->db->insert("todaythought",$data)){
	...
	public function editNews(){
		...
		$this->db->where("s_no",$this->input->post("id"));
		if($this->db->update("todaythought",$data)){
			redirect(base_url()."apanel/latestNews");
		}
		else{
			echo "Somthing going wrong. Please Contact Site administrator";
	...
	public function deleteNews(){
		$this->db->where("s_no",$this->uri->segment(3));
		if($this->db->delete("todaythought")){
			redirect(base_url()."apanel/latestNews");
		}
		else{
			echo "Somthing going wrong. Please Contact Site administrator";
