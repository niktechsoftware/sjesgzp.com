...
<head>
        ...
        <!-- Title -->
        <title><?php echo "St. Joseph's Admin Login"; ?></title>
                ...
                <div id="main-wrapper">
                    <div class="row">
                        <div class="col-md-3 center">
                            <div class="login-box">
                                <a href="<?php echo base_url()?>apanel/index" class="logo-name text-lg text-center">St. Joseph's School Admin Login</a>
