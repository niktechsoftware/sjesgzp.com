                        ...
                        <div class="col-md-12">
                            <div class="panel panel-white">
                            	<div class="panel-heading clearfix">
                                    <h4 class="panel-title">Enter Letest Thoughts</h4>
                                </div>
                            	<div class="panel-body">
                            	<?php if($this->uri->segment(3) == "edit"):?>
                            	<?php $this->db->where("s_no",$this->uri->segment(4));?>
                            	<?php $deta = $this->db->get("todaythought")->row();?>
                                   <form class="form-horizontal" action="<?php echo base_url()?>apanelForms/editNews" method="post">
                                        ...
                                        <div class="form-group">
                                            <label class="col-sm-2 control-label">Thought</label>
                                            <div class="col-sm-10">
                                            	<textarea rows="6" cols="60" class="form-control summernote" name="content" >
                                            		<?php echo $deta->thought;?>
                                            	</textarea>
                                            </div>
                                        </div>
                                         <div class="form-group">
                                            <label class="col-sm-2 control-label">Written by</label>
                                            <div class="col-sm-10">
                                            	<input rows="6" cols="60" class="form-control" name="url" 
                                            		value ="<?php echo $deta->written_by;?>"/>
                                            	
                                            </div>
                                        </div>
                                         <div class="col-sm-offset-2 col-sm-10">
                                            <button type="submit" class="btn btn-success">Edit Thought</button>
                                         </div>
                                    </form>
                                <?php else:?>
                            	...
                            	<div class="panel-body">
                                   <div class="table-responsive">
                                    <table id="example" class="display table" style="width: 100%; cellspacing: 0;">
                                        ...
                                        <tbody>
                                        	<?php $i = 1;?>
                                        	<?php $res = $this->db->get("todaythought")->result();?>
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $row->written_date; ?></td>
                                                <td>
                                                	<a href="<?php echo base_url();?>apanel/latestNews/edit/<?php echo $row->s_no;?>">Edit</a> | 
                                                	<a href="<?php echo base_url();?>apanelForms/deleteNews/<?php echo $row->s_no;?>">Delete</a>
                                                </td>
                                            </tr>
                                            <?php $i++;?>
                                            <?php endforeach;?>
